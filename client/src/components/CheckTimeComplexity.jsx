  ...
  const handleSubmit = async (e) => {
    try {
      ...
      const response = await fetch(
        "http://localhost:8000/api/tools/time-complexity",
        {
          method: "POST",
          headers: {
  ...
  return 0;
          ...
          <div>
            <textarea
              ...
              id="timeComplexity"
              className="w-96 h-96 px-3 bg-gray-300 font-bold"
            ></textarea>
          </div>
        </div>
        <input
...
export default CheckTimeComplexity;
